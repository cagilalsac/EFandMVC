...
public partial class NorthwindLiteV2Context : DbContext
{
    public NorthwindLiteV2Context()
    {
    }

    public NorthwindLiteV2Context(DbContextOptions<NorthwindLiteV2Context> options)
        : base(options)
    {
    }
