...
namespace _02_EFandMVC_NorthwindLite
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Hem Package Manager Console'da Scaffold-DbContext komutunun çalýþmasý hem de ilgili controller'larda
            // controller constructor'ý üzerinden NorthwindLiteV2Context tipindeki objenin Dependency Injection ile
            ...
            // web uygulamamýza servis olarak eklenen AddDbContext methodu ile NorthwindLiteV2Context tipindeki objenin
            // alýnan connection string üzerinden baðýmlýlýðýnýn yönetilmesi saðlanýr.
            string connectionString = builder.Configuration.GetConnectionString("DefaultConnection");
            builder.Services.AddDbContext<NorthwindLiteV2Context>(options => options.UseSqlServer(connectionString));
            #endregion
